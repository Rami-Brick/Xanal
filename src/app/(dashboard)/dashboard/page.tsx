...
export const metadata: Metadata = { title: "Vue d'ensemble Â· Xanal" };
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(190px, 1fr))", gap: 12 }}>
        {[
          ...
          { label: "LivrÃ©es", value: fmt(d.deliveredOrders), sub: `${pct(d.deliveredOrders, d.totalOrders)} du total` },
          { label: "RetournÃ©es", value: fmt(d.returnedOrders), sub: `${pct(d.returnedOrders, d.totalOrders)} du total` },
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 12 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <div style={{ ...card, flex: 1 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 10 }}>
              ...
              <span style={{ fontSize: 13, color: syncTone.text, fontWeight: 500 }}>
                {d.syncFreshness === "stable" ? "DonnÃ©es fraÃ®ches" : d.syncFreshness === "watch" ? "Ã€ rafraÃ®chir" : "Sync Ã  sÃ©curiser"}
              </span>
            </div>
          ...
          <div style={card}>
            <p style={eyebrow}>Boutiques connectÃ©es</p>
